...
; (function(b) {
    var a = {
        ...
        _createScore: function() {
        	var This= this
        	b("<span class='raty-con'></span>").appendTo(This);
            This.stars.hover(function() {
            	$(this).nextAll("span.raty-con").show();
            	if(!This.opt.htmls){
            		$(this).nextAll("span.raty-con").html("<h2>"+a._getHint.call(This,this.alt)+"</h2>");
            	}else{
            		$(this).nextAll("span.raty-con").html("<h2>"+a._getHint.call(This,this.alt)+"</h2>"+This.opt.htmls[this.alt-1]);
            	}
            },function(){
				$(this).nextAll("span.raty-con").hide();
			});	
            return b("<input />", {
                type: "hidden",
